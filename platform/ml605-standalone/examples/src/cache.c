...
// This program runs engine for 5 seconds and then runs jpeg for 5 seconds,
...
//   0x3FFFFFF8: 0 -> interrupt and program in cx0
//               1 -> interrupt in cx0, program in cx1
//   0x3FFFFFFC: wakeup configuration
//
...
#define USE_WAKE    config[2]
#define WAKE_CFG    config[3]
