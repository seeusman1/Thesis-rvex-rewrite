...
.PHONY: cache-pd-%
cache-pd-%:
	#$(RVD) -c0 w IDMEM+0x3FFF0 0x8818  1111
	#$(RVD) -c0 w IDMEM+0x3FFF8 0x8810  1111
	#$(RVD) -c0 w IDMEM+0x3FFF4 0x1188  1011
	#$(RVD) -c0 w IDMEM+0x3FFFC 0x1180  1011
	$(RVD) -c0 w IDMEM+0x3FFF0 0x1188
	$(RVD) -c0 w IDMEM+0x3FFF8 0x8880
	$(RVD) -c0 w IDMEM+0x3FFF4 0x1188
	$(RVD) -c0 w IDMEM+0x3FFFC 0x8880
	$(RVD) -c0 w 0xF1000004 '(10*$*)-1'
