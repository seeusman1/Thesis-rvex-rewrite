...
--=============================================================================
  ...
  port (
    ...
    -- generator.
    rv2cxreg_coreID             : in  rvex_byte_type;

    ---------------------------------------------------------------------------
    -- Run control interface
    ---------------------------------------------------------------------------
    -- Active high context reset output. This should be wired to the ctxtReset                       -- GENERATED --
    -- signal externally.
    ...
    -- register, which stops the core. This bit can be reset by issuing a core                       -- GENERATED --
    ...
    -- bit 3 specifies whether the pipelane group should be disabled (high) or                       -- GENERATED --
    ...
    ---------------------------------------------------------------------------
    -- Trace control unit interface                                                                  -- GENERATED --
    ---------------------------------------------------------------------------
...
end core_contextRegLogic;                                                                            -- GENERATED --
...
--=============================================================================
  ...
  function vec2bit(x: std_logic_vector) return std_logic is
    variable y : std_logic;                                                                          -- GENERATED --
  begin
    y := '0';
  ...
  signal cr_sccr_b_r          : std_logic_vector(2**CFG.numContextsLog2-1 downto 0);                 -- GENERATED --
  ...
  signal cr_br1_br1_r         : rvex_address_array(2**CFG.numContextsLog2-1 downto 0);               -- GENERATED --
  ...
  signal cr_dcr_br3_r         : rvex_2bit_array(2**CFG.numContextsLog2-1 downto 0);                  -- GENERATED --
  ...
  signal cr_dcr2_e_r          : std_logic_vector(2**CFG.numContextsLog2-1 downto 0);                 -- GENERATED --
...
--=============================================================================
  ...
  cxreg_gen: for ctxt in 0 to 2**CFG.numContextsLog2-1 generate
    cxregs: process (clk) is
      ...
      variable cr_ccr_branch_write: std_logic_vector(7 downto 0);                                    -- GENERATED --
      ...
      variable cr_ccr_c_cmd       : std_logic_vector(1 downto 0);                                    -- GENERATED --
      ...
      variable cr_ccr_r_cmd       : std_logic_vector(1 downto 0);                                    -- GENERATED --
      ...
      variable cr_sccr_k_read     : std_logic_vector(1 downto 0);                                    -- GENERATED --
      ...
      variable cr_sccr_b_read     : std_logic_vector(1 downto 0);                                    -- GENERATED --
      ...
      variable cr_sccr_i_read     : std_logic_vector(1 downto 0);                                    -- GENERATED --
      ...
      variable cr_th_th_wmask     : std_logic_vector(31 downto 0);                                   -- GENERATED --
      ...
      variable cr_ta_ta_read      : std_logic_vector(31 downto 0);                                   -- GENERATED --
      ...
      variable cr_br1_br1_mask    : rvex_address_type;                                               -- GENERATED --
      ...
      variable cr_br3_br3_mask    : rvex_address_type;                                               -- GENERATED --
      ...
      variable cr_dcr_e_read      : std_logic_vector(0 downto 0);                                    -- GENERATED --
      ...
      variable cr_dcr_b_read      : std_logic_vector(0 downto 0);                                    -- GENERATED --
    ...
    begin
      if rising_edge(clk) then
        ...
        if reset = '1' then
          ...
          cxreg2cfg_requestData(ctxt) <= std_logic_vector(to_unsigned(0, 32));
          ...
          if ctxtReset(ctxt) = '1' then
            ...
            cxreg2cfg_requestData(ctxt) <= std_logic_vector(to_unsigned(0, 32));                     -- GENERATED --
            cxreg2cfg_requestEnable(ctxt) <= bool2bit(int2bool(0));
            cr_ccr_cause_r(ctxt) <= std_logic_vector(to_unsigned(0, 8));
            ...
            cr_sccr_id_read := std_logic_vector(resize((resize(unsigned(rv2cxreg_coreID), 32)) + (to_unsigned(ctxt, 32)), 8));
            ...
            cr_tp_tp_write := bus_writeData((0)+31 downto 0);                                        -- GENERATED --
            ...
            cr_ta_ta_read := cr_ta_ta_r(ctxt);                                                       -- GENERATED --
            if ((not (bit2bool(cxplif2cxreg_stall(ctxt)))) and (bit2bool(cxplif2cxreg_trapInfo(ctxt).active))) then
            ...
            if ((to_unsigned(CFG.numBreakpoints, 31)) > (to_unsigned(0, 31))) then
              if (bit2bool(cr_dcr_e_r(ctxt))) then
                cr_br0_br0_mask := cr_br0_br0_wmask_dbg;                                             -- GENERATED --
              else
            ...
            cr_br1_br1_wmask := ((bus_writeMaskDbg((0)+31 downto 0)) or (bus_writeMaskCore((0)+31 downto 0))) and ((31 downto 0 => bool2bit((resize(bus_wordAddr, 31)) = (to_unsigned(9, 31))))); -- GENERATED --
            cr_br1_br1_mask := std_logic_vector(to_unsigned(0, 32));
            if ((to_unsigned(CFG.numBreakpoints, 31)) > (to_unsigned(1, 31))) then
              if (bit2bool(cr_dcr_e_r(ctxt))) then
              ...
              cxreg2cxplif_breakpoints(ctxt).addr(1) <= cr_br1_br1_r(ctxt);                          -- GENERATED --
            end if;
            ...
            if ((to_unsigned(CFG.numBreakpoints, 31)) > (to_unsigned(2, 31))) then
              if (bit2bool(cr_dcr_e_r(ctxt))) then
                cr_br2_br2_mask := cr_br2_br2_wmask_dbg;
              else
                cr_br2_br2_mask := cr_br2_br2_wmask;                                                 -- GENERATED --
              end if;
            ...
            if ((to_unsigned(CFG.numBreakpoints, 31)) > (to_unsigned(3, 31))) then                   -- GENERATED --
              if (bit2bool(cr_dcr_e_r(ctxt))) then
            ...
            cr_dcr_d_write := bus_writeData((31)+0 downto 31);                                       -- GENERATED --
            ...
            cr_dcr_j_read := bit2vec(cr_dcr_j_r(ctxt), 1);                                           -- GENERATED --
            ...
            if ((not (bit2bool(cxplif2cxreg_stall(ctxt)))) and (bit2bool(cxplif2cxreg_resuming_ack(ctxt)))) then -- GENERATED --
              cr_dcr_r_r(ctxt) <= '0';
            end if;
            ...
            cr_dcr_b_write := bus_writeData((24)+0 downto 24);                                       -- GENERATED --
            ...
            cr_dcr_cause_write := bus_writeData((16)+7 downto 16);                                   -- GENERATED --
            ...
            cr_dcr_br3_mask := std_logic_vector(to_unsigned(0, 2));                                  -- GENERATED --
            cr_dcr_br3_v := std_logic_vector(to_unsigned(0, 2));
            if ((to_unsigned(CFG.numBreakpoints, 31)) > (to_unsigned(3, 31))) then
              ...
              cr_dcr_br3_read := cr_dcr_br3_r(ctxt);                                                 -- GENERATED --
            ...
            if ((to_unsigned(CFG.numBreakpoints, 31)) > (to_unsigned(2, 31))) then
              cr_dcr_br2_v := cr_dcr_br2_r(ctxt);                                                    -- GENERATED --
              if (bit2bool(cr_dcr_e_r(ctxt))) then
            ...
            cr_dcr_br0_wmask := ((bus_writeMaskDbg((0)+1 downto 0)) or (bus_writeMaskCore((0)+1 downto 0))) and ((1 downto 0 => bool2bit((resize(bus_wordAddr, 31)) = (to_unsigned(12, 31))))); -- GENERATED --
            ...
            if ((to_unsigned(CFG.numBreakpoints, 31)) > (to_unsigned(0, 31))) then
              ...
              cr_dcr_br0_v := ((cr_dcr_br0_v) and (not (cr_dcr_br0_mask))) or ((cr_dcr_br0_write) and (cr_dcr_br0_mask)); -- GENERATED --
            ...
            if (CFG.traceEnable) then
              cr_dcr2_trcap_read := bitvec_lit("11111001");                                          -- GENERATED --
            else
            ...
            if (CFG.traceEnable) then
              ...
              cr_dcr2_t_read := bit2vec('0', 1);                                                     -- GENERATED --
            end if;
            ...
            cr_dcr2_r_write := bus_writeData((5)+0 downto 5);                                        -- GENERATED --
            ...
            if (CFG.traceEnable) then
              ...
              cr_dcr2_i_read := bit2vec(cr_dcr2_i_r(ctxt), 1);                                       -- GENERATED --
            else
            ...
            if (CFG.traceEnable) then
              ...
              cr_dcr2_e_read := bit2vec('0', 1);                                                     -- GENERATED --
            end if;
            ...
            case creg2cxreg_addr(ctxt)(8 downto 2) is
              ...
              when "0010000" => cxreg2creg_readData(ctxt) <= bitvec_lit("00000000000000000000000000000000"); -- GENERATED --
              when "0010010" => cxreg2creg_readData(ctxt) <= bitvec_lit("00000000000000000000000000000000");
              when "0010011" => cxreg2creg_readData(ctxt) <= ((bitvec_lit("000000000000000000000000")) & (cr_sawc_run_read)) & (bitvec_lit("0"));
              when "0010100" => cxreg2creg_readData(ctxt) <= bitvec_lit("00000000000000000000000000000000");
              when "0010101" => cxreg2creg_readData(ctxt) <= bitvec_lit("00000000000000000000000000000000");
              when "0010110" => cxreg2creg_readData(ctxt) <= bitvec_lit("00000000000000000000000000000000");
              when "0010111" => cxreg2creg_readData(ctxt) <= bitvec_lit("00000000000000000000000000000000");
              when "0011000" => cxreg2creg_readData(ctxt) <= bitvec_lit("00000000000000000000000000000000");
              when "0011001" => cxreg2creg_readData(ctxt) <= bitvec_lit("00000000000000000000000000000000");
              when "0011010" => cxreg2creg_readData(ctxt) <= bitvec_lit("00000000000000000000000000000000");
              when "0011011" => cxreg2creg_readData(ctxt) <= bitvec_lit("00000000000000000000000000000000"); -- GENERATED --
              when "0011100" => cxreg2creg_readData(ctxt) <= bitvec_lit("00000000000000000000000000000000");
              when "0011101" => cxreg2creg_readData(ctxt) <= bitvec_lit("00000000000000000000000000000000");
              when "0011110" => cxreg2creg_readData(ctxt) <= bitvec_lit("00000000000000000000000000000000");
              when "0011111" => cxreg2creg_readData(ctxt) <= bitvec_lit("00000000000000000000000000000000");
              when "0100000" => cxreg2creg_readData(ctxt) <= bitvec_lit("00000000000000000000000000000000");
              when "0100001" => cxreg2creg_readData(ctxt) <= bitvec_lit("00000000000000000000000000000000");
              when "0100010" => cxreg2creg_readData(ctxt) <= bitvec_lit("00000000000000000000000000000000");
              when "0100011" => cxreg2creg_readData(ctxt) <= bitvec_lit("00000000000000000000000000000000");
              when "0100100" => cxreg2creg_readData(ctxt) <= bitvec_lit("00000000000000000000000000000000");
              when "0100101" => cxreg2creg_readData(ctxt) <= bitvec_lit("00000000000000000000000000000000"); -- GENERATED --
              when "0100110" => cxreg2creg_readData(ctxt) <= bitvec_lit("00000000000000000000000000000000");
              when "0100111" => cxreg2creg_readData(ctxt) <= bitvec_lit("00000000000000000000000000000000");
              when "1000000" => cxreg2creg_readData(ctxt) <= bitvec_lit("00000000000000000000000000000000");
              when "1000010" => cxreg2creg_readData(ctxt) <= bitvec_lit("00000000000000000000000000000000");
              when "1000100" => cxreg2creg_readData(ctxt) <= bitvec_lit("00000000000000000000000000000000");
              when "1000110" => cxreg2creg_readData(ctxt) <= bitvec_lit("00000000000000000000000000000000");
              when "1001000" => cxreg2creg_readData(ctxt) <= bitvec_lit("00000000000000000000000000000000");
              when "1001010" => cxreg2creg_readData(ctxt) <= bitvec_lit("00000000000000000000000000000000");
              when "1001100" => cxreg2creg_readData(ctxt) <= bitvec_lit("00000000000000000000000000000000");
              when "1001110" => cxreg2creg_readData(ctxt) <= bitvec_lit("00000000000000000000000000000000"); -- GENERATED --
              when "1010000" => cxreg2creg_readData(ctxt) <= bitvec_lit("00000000000000000000000000000000");
              when "1010010" => cxreg2creg_readData(ctxt) <= bitvec_lit("00000000000000000000000000000000");
              when "1010100" => cxreg2creg_readData(ctxt) <= bitvec_lit("00000000000000000000000000000000");
              when "1010110" => cxreg2creg_readData(ctxt) <= bitvec_lit("00000000000000000000000000000000");
              when "1011000" => cxreg2creg_readData(ctxt) <= bitvec_lit("00000000000000000000000000000000");
    ...
    cxreg2trace_enable(ctxt) <= cr_dcr2_e_r(ctxt);                                                   -- GENERATED --
