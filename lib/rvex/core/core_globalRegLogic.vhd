...
--=============================================================================
  ...
  port (
    ...
    -- MMU design-time configuration.                                                                -- GENERATED --
    mem2gbreg_mmuConfig         : in  rvex_mmuConfig_type;
    ...
    -- ASCII platform tag code for the platform version registers.                                   -- GENERATED --
    ...
    -- Write command.
    creg2gbreg_dbgWriteEnable   : in  std_logic;                                                     -- GENERATED --
...
--=============================================================================
  ...
  -- Generated registers.
  signal cr_bcrr_bcrr_r       : rvex_data_type;                                                      -- GENERATED --
...
--=============================================================================
  ...
  gbregs: process (clk) is
    ...
    variable cr_limc7_borrow15_read: std_logic_vector(15 downto 0);                                  -- GENERATED --
    ...
    variable cr_limc2_borrow5_read: std_logic_vector(15 downto 0);                                   -- GENERATED --
    ...
    variable cr_sic3_syl14cap_read: std_logic_vector(7 downto 0);                                    -- GENERATED --
    ...
    constant cr_sic3_syl12cap_groupMask: natural := ((1) * 2**((CFG.numLanesLog2) - (CFG.numLaneGroupsLog2))) - (1); -- GENERATED --
    ...
    constant cr_sic1_syl7cap_groupMask: natural := ((1) * 2**((CFG.numLanesLog2) - (CFG.numLaneGroupsLog2))) - (1); -- GENERATED --
    ...
    variable cr_sic1_syl4cap_read: std_logic_vector(7 downto 0);                                     -- GENERATED --
    ...
    constant cr_sic0_syl2cap_groupMask: natural := ((1) * 2**((CFG.numLanesLog2) - (CFG.numLaneGroupsLog2))) - (1); -- GENERATED --
    ...
    variable cr_ext1_asid_read  : std_logic_vector(4 downto 0);
    variable cr_ext1_lp_read    : std_logic_vector(4 downto 0);
    variable cr_ext1_np_read    : std_logic_vector(4 downto 0);
    variable cr_ext1_m_read     : std_logic_vector(0 downto 0);
    variable cr_ext0_t_read     : std_logic_vector(0 downto 0);
    variable cr_ext0_brk_read   : std_logic_vector(2 downto 0);                                      -- GENERATED --
    ...
    variable cr_cver1_ver_read  : std_logic_vector(7 downto 0);                                      -- GENERATED --
    ...
    variable cr_pver1_ptag1_read: std_logic_vector(7 downto 0);                                      -- GENERATED --
  ...
  begin
    if rising_edge(clk) then
      if reset = '1' then
        ...
        bus_wordAddr := unsigned(creg2gbreg_dbgAddr(7 downto 2));                                    -- GENERATED --
        perf_count_clear := '0';
        ...
        gbreg2rv_reset <= vec2bit((cr_gsr_r_wmask_dbg) and (cr_gsr_r_write));                        -- GENERATED --
        ...
        cr_aff_af_read := imem2gbreg_affinity;                                                       -- GENERATED --
        ...
        if (CFG.limmhFromNeighbor) then
          cr_limc7_borrow15_read((2) * (7)) := '1';                                                  -- GENERATED --
        end if;
        if (CFG.limmhFromPreviousPair) then
        ...
        if (CFG.limmhFromPreviousPair) then
          cr_limc6_borrow13_read(((2) * (6)) + (1)) := '1';                                          -- GENERATED --
        ...
        if (CFG.limmhFromPreviousPair) then
          ...
          cr_limc3_borrow6_read := std_logic_vector((unsigned(cr_limc3_borrow6_read)) srl (2));      -- GENERATED --
        end if;
        if (CFG.limmhFromNeighbor) then
        ...
        if (CFG.limmhFromNeighbor) then
          cr_limc2_borrow5_read((2) * (2)) := '1';                                                   -- GENERATED --
        end if;
        if (CFG.limmhFromPreviousPair) then
        ...
        if (CFG.limmhFromPreviousPair) then
          cr_limc1_borrow3_read(((2) * (1)) + (1)) := '1';                                           -- GENERATED --
        ...
        cr_sic3_syl15cap_read(3) := bool2bit((((cr_sic3_syl15cap_lane) + (1)) mod ((1) * 2**(CFG.bundleAlignLog2))) = (0)); -- GENERATED --
        ...
        cr_sic3_syl12cap_read(1) := bool2bit(int2bool(to_integer((to_unsigned(CFG.multiplierLanes, 31)) and (to_unsigned((1) * 2**(cr_sic3_syl12cap_lane), 31))))); -- GENERATED --
        ...
        cr_sic2_syl10cap_read(3) := bool2bit((((cr_sic2_syl10cap_lane) + (1)) mod ((1) * 2**(CFG.bundleAlignLog2))) = (0)); -- GENERATED --
        ...
        cr_sic1_syl7cap_read(1) := bool2bit(int2bool(to_integer((to_unsigned(CFG.multiplierLanes, 31)) and (to_unsigned((1) * 2**(cr_sic1_syl7cap_lane), 31))))); -- GENERATED --
        ...
        cr_sic1_syl5cap_read(3) := bool2bit((((cr_sic1_syl5cap_lane) + (1)) mod ((1) * 2**(CFG.bundleAlignLog2))) = (0)); -- GENERATED --
        ...
        cr_sic0_syl2cap_read(1) := bool2bit(int2bool(to_integer((to_unsigned(CFG.multiplierLanes, 31)) and (to_unsigned((1) * 2**(cr_sic0_syl2cap_lane), 31))))); -- GENERATED --
        ...
        cr_sic0_syl0cap_read(3) := bool2bit((((cr_sic0_syl0cap_lane) + (1)) mod ((1) * 2**(CFG.bundleAlignLog2))) = (0)); -- GENERATED --
        ...
        if (CFG.forwarding) then
          if ((L_MUL) = (0)) then
            cr_gps0_mulc_read := std_logic_vector(to_unsigned((S_MUL) + (1), 4));                    -- GENERATED --
          else
        ...
        if (CFG.forwarding) then
          if ((L_ALU) = (0)) then
            ...
            cr_gps0_aluc_read := std_logic_vector(to_unsigned((S_ALU) + (L_ALU), 4));                -- GENERATED --
          end if;
        else
        ...
        if (CFG.forwarding) then
          if ((L_MEM) = (0)) then
            ...
            cr_sps0_memdc_read := std_logic_vector(to_unsigned((S_MEM) + (L_MEM), 4));               -- GENERATED --
          end if;
        else
        ...
        if (CFG.forwarding) then
          ...
          cr_sps0_alur_read := std_logic_vector(to_unsigned(S_SRD, 4));                              -- GENERATED --
        end if;
        if (mem2gbreg_mmuConfig.mmuEnable) then
          cr_ext1_asid_read := std_logic_vector(to_unsigned(mem2gbreg_mmuConfig.asidBitWidth, 5));
        else
          cr_ext1_asid_read := std_logic_vector(to_unsigned(0, 5));
        end if;
        if (mem2gbreg_mmuConfig.mmuEnable) then
          cr_ext1_lp_read := std_logic_vector(to_unsigned((mem2gbreg_mmuConfig.largePageSizeLog2) - (2), 5));
        else
          cr_ext1_lp_read := std_logic_vector(to_unsigned(0, 5));                                    -- GENERATED --
        end if;
        if (mem2gbreg_mmuConfig.mmuEnable) then
          cr_ext1_np_read := std_logic_vector(to_unsigned((mem2gbreg_mmuConfig.pageSizeLog2) - (2), 5));
        else
          cr_ext1_np_read := std_logic_vector(to_unsigned(0, 5));
        end if;
        cr_ext1_m_read := bit2vec(bool2bit(mem2gbreg_mmuConfig.mmuEnable), 1);
        cr_ext0_t_read := bit2vec(bool2bit(CFG.traceEnable), 1);
        cr_ext0_brk_read := std_logic_vector(to_unsigned(CFG.numBreakpoints, 3));
        cr_ext0_c_read := bit2vec(bool2bit(CFG.cachePerfCountEnable), 1);                            -- GENERATED --
        ...
        cr_cver1_ctag0_read := RVEX_CORE_TAG((48)+7 downto 48);                                      -- GENERATED --
        ...
        cr_pver1_ptag2_read := rv2gbreg_platformTag((32)+7 downto 32);                               -- GENERATED --
        ...
        case creg2gbreg_dbgAddr(7 downto 2) is
          ...
          when "000010" => gbreg2creg_dbgReadData <= cr_cc_cc_read;                                  -- GENERATED --
          ...
          when "101110" => gbreg2creg_dbgReadData <= (cr_limc1_borrow3_read) & (cr_limc1_borrow2_read); -- GENERATED --
          ...
          when "111000" => gbreg2creg_dbgReadData <= bitvec_lit("00000000000000000000000000000000"); -- GENERATED --
          when "111001" => gbreg2creg_dbgReadData <= ((((bitvec_lit("0000000000000000")) & (cr_ext1_asid_read)) & (cr_ext1_lp_read)) & (cr_ext1_np_read)) & (cr_ext1_m_read);
        ...
        for laneGroup in 0 to 2**CFG.numLaneGroupsLog2-1 loop                                        -- GENERATED --
          case creg2gbreg_coreAddr(laneGroup)(7 downto 2) is
            ...
            when "101010" => gbreg2creg_coreReadData(laneGroup) <= (cr_limc5_borrow11_read) & (cr_limc5_borrow10_read); -- GENERATED --
            ...
            when "110100" => gbreg2creg_coreReadData(laneGroup) <= bitvec_lit("00000000000000000000000000000000"); -- GENERATED --
            ...
            when "111001" => gbreg2creg_coreReadData(laneGroup) <= ((((bitvec_lit("0000000000000000")) & (cr_ext1_asid_read)) & (cr_ext1_lp_read)) & (cr_ext1_np_read)) & (cr_ext1_m_read);
            ...
            when "111110" => gbreg2creg_coreReadData(laneGroup) <= (((cr_pver1_coid_read) & (cr_pver1_ptag0_read)) & (cr_pver1_ptag1_read)) & (cr_pver1_ptag2_read); -- GENERATED --
  ...
  gbreg2cfg_requestData <= cr_bcrr_bcrr_r;                                                           -- GENERATED --
