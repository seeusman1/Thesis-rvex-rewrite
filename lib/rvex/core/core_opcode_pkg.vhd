...
--=============================================================================
  ...
  constant opcodeTableEntry_default : opcodeTableEntry_type := (                                     -- GENERATED --
    ...
    enableMul => '0', isLIMMH => '0', isTrap => '0'), aluCtrl => (compare => '0',
    bitwiseOp => BITW_OR, op1Mux => EXTEND32, op2Mux => ZERO, shiftLeft => '0',
    intResultMux => BITWISE, brResultMux => PASS, unsignedOp => '0', divs => '0',
    opBrMux => PASS), fpuCtrl => (addOp => ADD, unsignedOp => '0', cmpOp => EQ),                     -- GENERATED --
    branchCtrl => (isBranchInstruction => '0', stop => '0', branchIfFalse => '0',
  ...
  constant OPCODE_TABLE : opcodeTable_type := (
    ...
    98 => (
      ...
      opBrMux => FALSE), fpuCtrl => (addOp => ADD, unsignedOp => '0',
      cmpOp => EQ), branchCtrl => (isBranchInstruction => '0', stop => '0',
    ...
    107 => (
      ...
      fpuCtrl => (addOp => ADD, unsignedOp => '0', cmpOp => EQ),
    ...
    26 => (
      ...
      intResultMux => ADDER, brResultMux => PASS, unsignedOp => '0', divs => '0',
      opBrMux => TRUE), fpuCtrl => (addOp => ADD, unsignedOp => '0', cmpOp => EQ),
      branchCtrl => (isBranchInstruction => '0', stop => '0',
      branchIfFalse => '0', branchToLink => '0', link => '0', branchIfTrue => '0',
      RFI => '0'), memoryCtrl => (isMemoryInstruction => '0', unsignedOp => '0',
      readEnable => '0', accessSizeBLog2 => ACCESS_SIZE_WORD, writeEnable => '0'),
    ...
    120 to 127 => (
      ...
      divs => '0', opBrMux => PASS), fpuCtrl => (addOp => ADD, unsignedOp => '0',
      cmpOp => EQ), branchCtrl => (isBranchInstruction => '0', stop => '0',
      branchIfFalse => '0', branchToLink => '0', link => '0', branchIfTrue => '0',
      RFI => '0'), memoryCtrl => (isMemoryInstruction => '0', unsignedOp => '0',
      readEnable => '0', accessSizeBLog2 => ACCESS_SIZE_WORD, writeEnable => '0'),
    ...
    111 => (
      ...
      syntax_imm => "shl r#.%r1 = r#.%r2, %ih                          ",                            -- GENERATED --
      valid => "11", datapathCtrl => (op3LinkReg => '0', stackOp => '0',
      funcSel => ALU, op1LinkReg => '0', enableMem => '0', enableALU => '1',
      brFmt => '1', isNOP => '0', gpRegWE => '1', linkWE => '0',
      ...
      divs => '0', opBrMux => FALSE), fpuCtrl => (addOp => ADD, unsignedOp => '0',
      cmpOp => EQ), branchCtrl => (isBranchInstruction => '0', stop => '0',                          -- GENERATED --
      branchIfFalse => '0', branchToLink => '0', link => '0', branchIfTrue => '0',
      RFI => '0'), memoryCtrl => (isMemoryInstruction => '0', unsignedOp => '0',
      readEnable => '0', accessSizeBLog2 => ACCESS_SIZE_WORD, writeEnable => '0'),
    ...
    24 => (
      ...
      syntax_imm => "shr r#.%r1 = r#.%r2, %ih                          ",                            -- GENERATED --
      valid => "11", datapathCtrl => (op3LinkReg => '0', stackOp => '0',
      funcSel => ALU, op1LinkReg => '0', enableMem => '0', enableALU => '1',
      brFmt => '1', isNOP => '0', gpRegWE => '1', linkWE => '0',
      allBrRegsWE => '0', op3BranchRegs => '0', brRegWE => '0',
    ...
    25 => (
      ...
      syntax_imm => "shru r#.%r1 = r#.%r2, %ih                         ",                            -- GENERATED --
      valid => "11", datapathCtrl => (op3LinkReg => '0', stackOp => '0',
      funcSel => ALU, op1LinkReg => '0', enableMem => '0', enableALU => '1',
      brFmt => '1', isNOP => '0', gpRegWE => '1', linkWE => '0',
      allBrRegsWE => '0', op3BranchRegs => '0', brRegWE => '0',
    ...
    ---------------------------------------------------------------------------
    -- ALU bitwise instructions                                                                      -- GENERATED --
    ---------------------------------------------------------------------------
    99 => (
    ...
    31 => (
      ...
      allBrRegsWE => '0', op3BranchRegs => '0', brRegWE => '0',
      gpRegRdEnaB => '1', gpRegRdEnaA => '1', enableMul => '0', isLIMMH => '0',
      isTrap => '0'), aluCtrl => (compare => '0', bitwiseOp => BITW_XOR,                             -- GENERATED --
      op1Mux => EXTEND32, op2Mux => EXTEND32, shiftLeft => '0',
      intResultMux => BITWISE, brResultMux => PASS, unsignedOp => '0',
      divs => '0', opBrMux => FALSE), fpuCtrl => (addOp => ADD, unsignedOp => '0',
      cmpOp => EQ), branchCtrl => (isBranchInstruction => '0', stop => '0',
    ...
    44 => (
      ...
      op1Mux => EXTEND32, op2Mux => EXTEND32, shiftLeft => '0',
      intResultMux => BITWISE, brResultMux => PASS, unsignedOp => '0',
      divs => '0', opBrMux => TRUE), fpuCtrl => (addOp => ADD, unsignedOp => '0',
      cmpOp => EQ), branchCtrl => (isBranchInstruction => '0', stop => '0',
      branchIfFalse => '0', branchToLink => '0', link => '0', branchIfTrue => '0',
    ...
    88 => (                                                                                          -- GENERATED --
      ...
      isTrap => '0'), aluCtrl => (compare => '0', bitwiseOp => BITW_AND,
      op1Mux => EXTEND32, op2Mux => EXTEND32, shiftLeft => '0',
      intResultMux => BOOL, brResultMux => LOGIC_OR, unsignedOp => '0',                              -- GENERATED --
      divs => '0', opBrMux => FALSE), fpuCtrl => (addOp => ADD, unsignedOp => '0',
      cmpOp => EQ), branchCtrl => (isBranchInstruction => '0', stop => '0',
      branchIfFalse => '0', branchToLink => '0', link => '0', branchIfTrue => '0',
      RFI => '0'), memoryCtrl => (isMemoryInstruction => '0', unsignedOp => '0',
    ...
    84 => (                                                                                          -- GENERATED --
      ...
      isTrap => '0'), aluCtrl => (compare => '0', bitwiseOp => BITW_AND,
      op1Mux => EXTEND32, op2Mux => EXTEND32, shiftLeft => '0',
      intResultMux => BOOL, brResultMux => LOGIC_NAND, unsignedOp => '0',                            -- GENERATED --
      divs => '0', opBrMux => FALSE), fpuCtrl => (addOp => ADD, unsignedOp => '0',
      cmpOp => EQ), branchCtrl => (isBranchInstruction => '0', stop => '0',
      branchIfFalse => '0', branchToLink => '0', link => '0', branchIfTrue => '0',
      RFI => '0'), memoryCtrl => (isMemoryInstruction => '0', unsignedOp => '0',
    ...
    86 => (                                                                                          -- GENERATED --
      ...
      isTrap => '0'), aluCtrl => (compare => '0', bitwiseOp => BITW_AND,
      op1Mux => EXTEND32, op2Mux => EXTEND32, shiftLeft => '0',
      intResultMux => BOOL, brResultMux => LOGIC_NOR, unsignedOp => '0',                             -- GENERATED --
      divs => '0', opBrMux => FALSE), fpuCtrl => (addOp => ADD, unsignedOp => '0',
      cmpOp => EQ), branchCtrl => (isBranchInstruction => '0', stop => '0',
      branchIfFalse => '0', branchToLink => '0', link => '0', branchIfTrue => '0',
      RFI => '0'), memoryCtrl => (isMemoryInstruction => '0', unsignedOp => '0',
    ...
    56 to 63 => (
      ...
      syntax_imm => "slct r#.%r1 = b#.%b1, r#.%r2, %ih                 ",                            -- GENERATED --
      valid => "11", datapathCtrl => (op3LinkReg => '0', stackOp => '0',
      funcSel => ALU, op1LinkReg => '0', enableMem => '0', enableALU => '1',
      brFmt => '1', isNOP => '0', gpRegWE => '1', linkWE => '0',
      allBrRegsWE => '0', op3BranchRegs => '0', brRegWE => '0',
      ...
      opBrMux => PASS), fpuCtrl => (addOp => ADD, unsignedOp => '0', cmpOp => EQ),
    ...
    48 to 55 => (
      ...
      syntax_imm => "slctf r#.%r1 = b#.%b1, r#.%r2, %ih                ",                            -- GENERATED --
      valid => "11", datapathCtrl => (op3LinkReg => '0', stackOp => '0',
      funcSel => ALU, op1LinkReg => '0', enableMem => '0', enableALU => '1',
      brFmt => '1', isNOP => '0', gpRegWE => '1', linkWE => '0',
      allBrRegsWE => '0', op3BranchRegs => '0', brRegWE => '0',
      ...
      op1Mux => EXTEND32, op2Mux => EXTEND32, shiftLeft => '0',
      intResultMux => OP_SEL, brResultMux => PASS, unsignedOp => '0', divs => '0',
      opBrMux => INVERT), fpuCtrl => (addOp => ADD, unsignedOp => '0',
      cmpOp => EQ), branchCtrl => (isBranchInstruction => '0', stop => '0',                          -- GENERATED --
      branchIfFalse => '0', branchToLink => '0', link => '0', branchIfTrue => '0',
      RFI => '0'), memoryCtrl => (isMemoryInstruction => '0', unsignedOp => '0',
      readEnable => '0', accessSizeBLog2 => ACCESS_SIZE_WORD, writeEnable => '0'),
    ...
    101 => (
      ...
      syntax_imm => "max r#.%r1 = r#.%r2, %ih                          ",                            -- GENERATED --
      valid => "11", datapathCtrl => (op3LinkReg => '0', stackOp => '0',
      funcSel => ALU, op1LinkReg => '0', enableMem => '0', enableALU => '1',
      brFmt => '1', isNOP => '0', gpRegWE => '1', linkWE => '0',
      allBrRegsWE => '0', op3BranchRegs => '0', brRegWE => '0',
    ...
    104 => (
      ...
      syntax_imm => "minu r#.%r1 = r#.%r2, %ih                         ",                            -- GENERATED --
      valid => "11", datapathCtrl => (op3LinkReg => '0', stackOp => '0',
      funcSel => ALU, op1LinkReg => '0', enableMem => '0', enableALU => '1',
      brFmt => '1', isNOP => '0', gpRegWE => '1', linkWE => '0',
      allBrRegsWE => '0', op3BranchRegs => '0', brRegWE => '0',
    ...
    12 => (
      ...
      syntax_imm => "unknown                                           ",
      valid => "01", datapathCtrl => (op3LinkReg => '0', stackOp => '0',
      funcSel => ALU, op1LinkReg => '1', enableMem => '0', enableALU => '1',                         -- GENERATED --
    ...
    152 => (
      ...
      unsignedOp => '0', cmpOp => EQ), branchCtrl => (isBranchInstruction => '0',
    ...
    154 => (
      ...
      intResultMux => BITWISE, brResultMux => PASS, unsignedOp => '0',
      divs => '0', opBrMux => PASS), fpuCtrl => (addOp => ADD, unsignedOp => '0',
      cmpOp => GE), branchCtrl => (isBranchInstruction => '0', stop => '0',
      branchIfFalse => '0', branchToLink => '0', link => '0', branchIfTrue => '0',
      RFI => '0'), memoryCtrl => (isMemoryInstruction => '0', unsignedOp => '0',
      readEnable => '0', accessSizeBLog2 => ACCESS_SIZE_WORD, writeEnable => '0'),
      multiplierCtrl => (op2unsigned => '0', op1unsigned => '0',                                     -- GENERATED --
    ...
    158 => (
      ...
      intResultMux => BITWISE, brResultMux => PASS, unsignedOp => '0',
      divs => '0', opBrMux => PASS), fpuCtrl => (addOp => ADD, unsignedOp => '0',
      cmpOp => GT), branchCtrl => (isBranchInstruction => '0', stop => '0',
      branchIfFalse => '0', branchToLink => '0', link => '0', branchIfTrue => '0',
      RFI => '0'), memoryCtrl => (isMemoryInstruction => '0', unsignedOp => '0',
      readEnable => '0', accessSizeBLog2 => ACCESS_SIZE_WORD, writeEnable => '0'),
      multiplierCtrl => (op2unsigned => '0', op1unsigned => '0',                                     -- GENERATED --
    ...
    16 => (
      syntax_reg => "unknown                                           ",
      syntax_imm => "ldw r#.%r1 = %ih[r#.%r2]                          ",                            -- GENERATED --
    ...
    19 => (
      syntax_reg => "unknown                                           ",
      syntax_imm => "ldb r#.%r1 = %ih[r#.%r2]                          ",                            -- GENERATED --
      valid => "10", datapathCtrl => (op3LinkReg => '0', stackOp => '0',
      funcSel => MEM, op1LinkReg => '0', enableMem => '1', enableALU => '1',
      brFmt => '0', isNOP => '0', gpRegWE => '1', linkWE => '0',
      allBrRegsWE => '0', op3BranchRegs => '0', brRegWE => '0',
    ...
    20 => (
      syntax_reg => "unknown                                           ",
      syntax_imm => "ldbu r#.%r1 = %ih[r#.%r2]                         ",                            -- GENERATED --
      valid => "10", datapathCtrl => (op3LinkReg => '0', stackOp => '0',
      funcSel => MEM, op1LinkReg => '0', enableMem => '1', enableALU => '1',
      brFmt => '0', isNOP => '0', gpRegWE => '1', linkWE => '0',
      allBrRegsWE => '0', op3BranchRegs => '0', brRegWE => '0',
    ...
    46 => (
      syntax_reg => "unknown                                           ",
      syntax_imm => "ldbr %ih[r#.%r2]                                  ",                            -- GENERATED --
      valid => "10", datapathCtrl => (op3LinkReg => '0', stackOp => '0',
      funcSel => MEM, op1LinkReg => '0', enableMem => '1', enableALU => '1',
      brFmt => '0', isNOP => '0', gpRegWE => '0', linkWE => '0',
    ...
    21 => (
      syntax_reg => "unknown                                           ",
      syntax_imm => "stw %ih[r#.%r2] = r#.%r1                          ",                            -- GENERATED --
      valid => "10", datapathCtrl => (op3LinkReg => '0', stackOp => '0',
    ...
    22 => (
      syntax_reg => "unknown                                           ",
      syntax_imm => "sth %ih[r#.%r2] = r#.%r1                          ",                            -- GENERATED --
      valid => "10", datapathCtrl => (op3LinkReg => '0', stackOp => '0',
      funcSel => ALU, op1LinkReg => '0', enableMem => '1', enableALU => '1',
      brFmt => '0', isNOP => '0', gpRegWE => '0', linkWE => '0',
      allBrRegsWE => '0', op3BranchRegs => '0', brRegWE => '0',
    ...
    23 => (
      syntax_reg => "unknown                                           ",
      syntax_imm => "stb %ih[r#.%r2] = r#.%r1                          ",                            -- GENERATED --
      valid => "10", datapathCtrl => (op3LinkReg => '0', stackOp => '0',
      funcSel => ALU, op1LinkReg => '0', enableMem => '1', enableALU => '1',
      brFmt => '0', isNOP => '0', gpRegWE => '0', linkWE => '0',
      allBrRegsWE => '0', op3BranchRegs => '0', brRegWE => '0',
    ...
    14 => (
      syntax_reg => "unknown                                           ",
      syntax_imm => "stw %ih[r#.%r2] = l#.0                            ",                            -- GENERATED --
    ...
    32 => (
      ...
      intResultMux => BITWISE, brResultMux => PASS, unsignedOp => '0',
      divs => '0', opBrMux => PASS), fpuCtrl => (addOp => ADD, unsignedOp => '0',
      cmpOp => EQ), branchCtrl => (isBranchInstruction => '1', stop => '0',
    ...
    40 => (
      ...
      intResultMux => BITWISE, brResultMux => PASS, unsignedOp => '0',
      divs => '0', opBrMux => PASS), fpuCtrl => (addOp => ADD, unsignedOp => '0',
      cmpOp => EQ), branchCtrl => (isBranchInstruction => '1', stop => '1',
      branchIfFalse => '0', branchToLink => '0', link => '0', branchIfTrue => '0',
      RFI => '0'), memoryCtrl => (isMemoryInstruction => '0', unsignedOp => '0',
      readEnable => '0', accessSizeBLog2 => ACCESS_SIZE_WORD, writeEnable => '0'),
      multiplierCtrl => (op2unsigned => '0', op1unsigned => '0',
