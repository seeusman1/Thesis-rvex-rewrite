...
--=============================================================================
  ...
  constant opcodeTableEntry_default : opcodeTableEntry_type := (                                     -- GENERATED --
    ...
    opBrMux => PASS), fpuCtrl => (hello => '0'),                                                     -- GENERATED --
  ...
  constant OPCODE_TABLE : opcodeTable_type := (
    ...
    107 => (
      ...
      fpuCtrl => (hello => '0'), branchCtrl => (isBranchInstruction => '0',
    ...
    110 => (
      ...
      gpRegRdEnaB => '1', gpRegRdEnaA => '1', enableMul => '0', isLIMMH => '0',
      isTrap => '0'), aluCtrl => (compare => '0', bitwiseOp => BITW_AND,
      op1Mux => SHL4, op2Mux => EXTEND32, shiftLeft => '0', intResultMux => ADDER,                   -- GENERATED --
      brResultMux => PASS, unsignedOp => '0', divs => '0', opBrMux => FALSE),
      fpuCtrl => (hello => '0'), branchCtrl => (isBranchInstruction => '0',
      stop => '0', branchIfFalse => '0', branchToLink => '0', link => '0',
      branchIfTrue => '0', RFI => '0'), memoryCtrl => (isMemoryInstruction => '0',
    ...
    26 => (                                                                                          -- GENERATED --
      ...
      intResultMux => ADDER, brResultMux => PASS, unsignedOp => '0', divs => '0',                    -- GENERATED --
      opBrMux => TRUE), fpuCtrl => (hello => '0'),
      branchCtrl => (isBranchInstruction => '0', stop => '0',
      branchIfFalse => '0', branchToLink => '0', link => '0', branchIfTrue => '0',
      RFI => '0'), memoryCtrl => (isMemoryInstruction => '0', unsignedOp => '0',
      readEnable => '0', accessSizeBLog2 => ACCESS_SIZE_WORD, writeEnable => '0'),
    ...
    120 to 127 => (                                                                                  -- GENERATED --
      ...
      isTrap => '0'), aluCtrl => (compare => '0', bitwiseOp => BITW_AND,
      op1Mux => EXTEND32, op2Mux => EXTEND32, shiftLeft => '0',
      intResultMux => ADDER, brResultMux => CARRY_OUT, unsignedOp => '1',                            -- GENERATED --
      divs => '0', opBrMux => PASS), fpuCtrl => (hello => '0'),
      branchCtrl => (isBranchInstruction => '0', stop => '0',
      branchIfFalse => '0', branchToLink => '0', link => '0', branchIfTrue => '0',
      RFI => '0'), memoryCtrl => (isMemoryInstruction => '0', unsignedOp => '0',
      readEnable => '0', accessSizeBLog2 => ACCESS_SIZE_WORD, writeEnable => '0'),
    ...
    112 to 119 => (                                                                                  -- GENERATED --
      ...
      isTrap => '0'), aluCtrl => (compare => '0', bitwiseOp => BITW_AND,
      op1Mux => SHL1, op2Mux => EXTEND32, shiftLeft => '0', intResultMux => ADDER,
      brResultMux => DIVS, unsignedOp => '0', divs => '1', opBrMux => PASS),                         -- GENERATED --
      fpuCtrl => (hello => '0'), branchCtrl => (isBranchInstruction => '0',
      stop => '0', branchIfFalse => '0', branchToLink => '0', link => '0',
      branchIfTrue => '0', RFI => '0'), memoryCtrl => (isMemoryInstruction => '0',
      unsignedOp => '0', readEnable => '0', accessSizeBLog2 => ACCESS_SIZE_WORD,
    ...
    111 => (
      ...
      divs => '0', opBrMux => FALSE), fpuCtrl => (hello => '0'),
      branchCtrl => (isBranchInstruction => '0', stop => '0',
      branchIfFalse => '0', branchToLink => '0', link => '0', branchIfTrue => '0',
      RFI => '0'), memoryCtrl => (isMemoryInstruction => '0', unsignedOp => '0',
      readEnable => '0', accessSizeBLog2 => ACCESS_SIZE_WORD, writeEnable => '0'),
    ...
    44 => (
      ...
      intResultMux => BITWISE, brResultMux => PASS, unsignedOp => '0',
      divs => '0', opBrMux => TRUE), fpuCtrl => (hello => '0'),
      branchCtrl => (isBranchInstruction => '0', stop => '0',
      branchIfFalse => '0', branchToLink => '0', link => '0', branchIfTrue => '0',
      RFI => '0'), memoryCtrl => (isMemoryInstruction => '0', unsignedOp => '0',
      readEnable => '0', accessSizeBLog2 => ACCESS_SIZE_WORD, writeEnable => '0'),
    ...
    ---------------------------------------------------------------------------
    64 => (
      syntax_reg => "cmpeq r#.%r1 = r#.%r2, r#.%r3                     ",                            -- GENERATED --
      ...
      opBrMux => TRUE), fpuCtrl => (hello => '0'),                                                   -- GENERATED --
      branchCtrl => (isBranchInstruction => '0', stop => '0',
      branchIfFalse => '0', branchToLink => '0', link => '0', branchIfTrue => '0',
      RFI => '0'), memoryCtrl => (isMemoryInstruction => '0', unsignedOp => '0',
      readEnable => '0', accessSizeBLog2 => ACCESS_SIZE_WORD, writeEnable => '0'),
    ...
    65 => (
      syntax_reg => "cmpeq b#.%b2 = r#.%r2, r#.%r3                     ",                            -- GENERATED --
    ...
    66 => (
      syntax_reg => "cmpge r#.%r1 = r#.%r2, r#.%r3                     ",                            -- GENERATED --
    ...
    67 => (
      syntax_reg => "cmpge b#.%b2 = r#.%r2, r#.%r3                     ",                            -- GENERATED --
    ...
    69 => (
      syntax_reg => "cmpgeu b#.%b2 = r#.%r2, r#.%r3                    ",                            -- GENERATED --
    ...
    70 => (
      syntax_reg => "cmpgt r#.%r1 = r#.%r2, r#.%r3                     ",                            -- GENERATED --
    ...
    71 => (
      syntax_reg => "cmpgt b#.%b2 = r#.%r2, r#.%r3                     ",                            -- GENERATED --
    ...
    74 => (
      syntax_reg => "cmple r#.%r1 = r#.%r2, r#.%r3                     ",                            -- GENERATED --
    ...
    75 => (
      syntax_reg => "cmple b#.%b2 = r#.%r2, r#.%r3                     ",                            -- GENERATED --
    ...
    76 => (
      syntax_reg => "cmpleu r#.%r1 = r#.%r2, r#.%r3                    ",                            -- GENERATED --
    ...
    77 => (
      syntax_reg => "cmpleu b#.%b2 = r#.%r2, r#.%r3                    ",                            -- GENERATED --
    ...
    79 => (
      syntax_reg => "cmplt b#.%b2 = r#.%r2, r#.%r3                     ",                            -- GENERATED --
    ...
    80 => (
      syntax_reg => "cmpltu r#.%r1 = r#.%r2, r#.%r3                    ",                            -- GENERATED --
    ...
    81 => (
      syntax_reg => "cmpltu b#.%b2 = r#.%r2, r#.%r3                    ",                            -- GENERATED --
    ...
    48 to 55 => (
      ...
      op1Mux => EXTEND32, op2Mux => EXTEND32, shiftLeft => '0',
      intResultMux => OP_SEL, brResultMux => PASS, unsignedOp => '0', divs => '0',
      opBrMux => INVERT), fpuCtrl => (hello => '0'),
      branchCtrl => (isBranchInstruction => '0', stop => '0',
      branchIfFalse => '0', branchToLink => '0', link => '0', branchIfTrue => '0',
      RFI => '0'), memoryCtrl => (isMemoryInstruction => '0', unsignedOp => '0',
      readEnable => '0', accessSizeBLog2 => ACCESS_SIZE_WORD, writeEnable => '0'),
    ...
    16 => (
      ...
      readEnable => '1', accessSizeBLog2 => ACCESS_SIZE_WORD, writeEnable => '0'),                   -- GENERATED --
      multiplierCtrl => (op2unsigned => '0', op1unsigned => '0',
      resultSel => PASS, op1sel => LOW_HALF, op2sel => LOW_HALF,
      isMultiplyInstruction => '0')
    ),
    ...
    22 => (
      ...
      branchIfFalse => '0', branchToLink => '0', link => '0', branchIfTrue => '0',
      RFI => '0'), memoryCtrl => (isMemoryInstruction => '1', unsignedOp => '0',
      readEnable => '0', accessSizeBLog2 => ACCESS_SIZE_HALFWORD,                                    -- GENERATED --
    ...
    32 => (
      ...
      op1Mux => EXTEND32, op2Mux => ZERO, shiftLeft => '0',
      intResultMux => BITWISE, brResultMux => PASS, unsignedOp => '0',
      divs => '0', opBrMux => PASS), fpuCtrl => (hello => '0'),                                      -- GENERATED --
    ...
    33 => (
      syntax_reg => "igoto l#.0                                        ",                            -- GENERATED --
    ...
    35 => (
      syntax_reg => "icall l#.0 = l#.0                                 ",                            -- GENERATED --
    ...
    37 => (
      syntax_reg => "brf b#.%b3, %bt                                   ",                            -- GENERATED --
    ...
    38 => (
      syntax_reg => "return r#.1 = r#.1, %bi, l#.0                     ",                            -- GENERATED --
      ...
      op1Mux => EXTEND32, op2Mux => EXTEND32, shiftLeft => '0',
      intResultMux => ADDER, brResultMux => PASS, unsignedOp => '0', divs => '0',
      opBrMux => FALSE), fpuCtrl => (hello => '0'),                                                  -- GENERATED --
      branchCtrl => (isBranchInstruction => '1', stop => '0',
      branchIfFalse => '1', branchToLink => '1', link => '0', branchIfTrue => '1',
      RFI => '0'), memoryCtrl => (isMemoryInstruction => '0', unsignedOp => '0',
      readEnable => '0', accessSizeBLog2 => ACCESS_SIZE_WORD, writeEnable => '0'),
    ...
    128 to 143 => (
      ...
      brFmt => '0', isNOP => '0', gpRegWE => '0', linkWE => '0',
      allBrRegsWE => '0', op3BranchRegs => '0', brRegWE => '0',
      gpRegRdEnaB => '0', gpRegRdEnaA => '0', enableMul => '0', isLIMMH => '1',                      -- GENERATED --
      isTrap => '0'), aluCtrl => (compare => '0', bitwiseOp => BITW_OR,
      op1Mux => EXTEND32, op2Mux => ZERO, shiftLeft => '0',
      intResultMux => BITWISE, brResultMux => PASS, unsignedOp => '0',
      divs => '0', opBrMux => PASS), fpuCtrl => (hello => '0'),
