...
\register{CYCH}{Cycle counter high}{0x240}
This register will automatically increment every time \creg{CYC} overflows. It
...
\register{STALL}{Stall cycle counter}{0x244}
This register will automatically increment every cycle while an instruction from
...
\register{STALLH}{Stall cycle counter high}{0x248}
This register will automatically increment every time \creg{STALL} overflows. It
will overflow when it reaches 0xFFFFFFFF.

\field{31..0}{Stall cycle counter high}
\debugCanWrite{}

%===============================================================================

\register{BUN}{Committed bundle counter}{0x24C}
...
\register{BUNH}{Committed bundle counter high}{0x250}
This register will automatically increment every time \creg{BUN} overflows. It
will overflow when it reaches 0xFFFFFFFF.

\field{31..0}{Committed bundle counter high}
\debugCanWrite{}

%===============================================================================

\register{SYL}{Committed syllable counter}{0x254}
This register will automatically increment whenever the results of executing a
non-\insn{NOP} syllable are committed. It will overflow when it reaches
...
\register{SYLH}{Committed syllable counter high}{0x258}
This register will automatically increment every time \creg{SYL} overflows. It
will overflow when it reaches 0xFFFFFFFF.

\field{31..0}{Committed syllable counter high}
\debugCanWrite{}

%===============================================================================

\register{NOP}{Committed NOP counter}{0x25C}
...
\register{NOPH}{Committed syllable counter high}{0x260}
This register will automatically increment every time \creg{NOP} overflows. It
will overflow when it reaches 0xFFFFFFFF.
...
\register{IACC}{Instruction cache access counter}{0x264}
...
\register{IACCH}{Instruction cache access counter high}{0x268}
This register increments every time \creg{IACC} overflows.

\field{31..0}{Instruction cache access counter high}
\debugCanWrite{}

%===============================================================================

\register{IMISS}{Instruction cache miss counter}{0x26C}
...
\register{IMISSH}{Instruction cache miss counter high}{0x270}
This register increments every time \creg{IMISS} overflows.

\field{31..0}{Instruction cache miss counter high}
\debugCanWrite{}

%===============================================================================

\register{DRACC}{Data cache read access counter}{0x274}
...
\register{DRACCH}{Data cache read access counter high}{0x278}
This register increments every time \creg{DRACC} overflows.

\field{31..0}{Data cache read access counter high}
\debugCanWrite{}

%===============================================================================

\register{DRMISS}{Data cache read miss counter}{0x27C}
...
\register{DRMISSH}{Data cache read miss counter high}{0x280}
This register increments every time \creg{DRMISS} overflows.

\field{31..0}{Data cache read miss counter high}
\debugCanWrite{}

%===============================================================================

\register{DWACC}{Data cache write access counter}{0x284}
...
\register{DWACCH}{Data cache write access counter high}{0x288}
This register increments every time \creg{DWACC} overflows.

\field{31..0}{Data cache write access counter high}
\debugCanWrite{}

%===============================================================================

\register{DWMISS}{Data cache write miss counter}{0x28C}
...
\register{DWMISSH}{Data cache write miss counter high}{0x290}
This register increments every time \creg{DWMISS} overflows.

\field{31..0}{Data cache write miss counter high}
\debugCanWrite{}

%===============================================================================

\register{DBYPASS}{Data cache bypass counter}{0x294}
...
\register{DBYPASSH}{Data cache bypass counter high}{0x298}
This register increments every time \creg{DBYPASS} overflows.

\field{31..0}{Data cache bypass counter high}
\debugCanWrite{}

%===============================================================================

\register{DWBUF}{Data cache write buffer counter}{0x29C}
...
\register{DWBUFH}{Data cache write buffer counter high}{0x2A0}
This register increments every time \creg{DWBUF} overflows.

\field{31..0}{Data cache write buffer counter high}
\debugCanWrite{}
...
\register{RSC}{Requested software context}{0x2B4}
...
\register{CSC}{Current software context}{0x2B8}
...
\register{SAWC}{Sleep and wake-up control register}{0x2F4}
...
\register{WCFG}{Wakeup configuration}{0x2F8}
