...
\ifaceSubGroup{}
\ifaceOutCtxt{cxplif}{currentPC}{address}{resetVect}
...
\ifaceSubGroup{}
\ifaceOutCtxt{cxplif}{breakpoints_addr_0}{address}{0}
\ifaceOutCtxt{cxplif}{breakpoints_addr_1}{address}{0}
\ifaceOutCtxt{cxplif}{breakpoints_addr_2}{address}{0}
\ifaceOutCtxt{cxplif}{breakpoints_addr_3}{address}{0}
\ifaceOutCtxt{cxplif}{breakpoints_cfg_0}{twoBit}{0}
\ifaceOutCtxt{cxplif}{breakpoints_cfg_1}{twoBit}{0}
\ifaceOutCtxt{cxplif}{breakpoints_cfg_2}{twoBit}{0}
\ifaceOutCtxt{cxplif}{breakpoints_cfg_3}{twoBit}{0}
...
%===============================================================================
\ifaceSubGroup{}
\ifaceOutCtxt{cfg}{requestData_r}{data}{0}
