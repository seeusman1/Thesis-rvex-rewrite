...
%===============================================================================
\ifaceSubGroup{}
\ifaceInCtxt{mem}{cacheTrace}{cacheTrace}
...
\ifaceOutCtxt{mem}{cacheControl}{cacheControl}{{others => 0}}
Cache status and control signals.

\ifaceSubGroup{}
\ifaceInCtxt{mem}{mmuStatus}{mmuStatus}
\ifaceOutCtxt{mem}{mmuControl}{mmuControl}{{others => 0}}
