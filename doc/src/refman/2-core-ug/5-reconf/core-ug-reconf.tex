...
\item Writes to the \creg{CRR} context control register from a program running
on the core. This section primarily deals with this mechanism.

\item Writes to the \creg{BCRR} global control register from the debug bus. This
