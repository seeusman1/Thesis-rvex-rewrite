...
\entitylbl{Trace unit}{trace}{core_trace.vhd}{
  This optional unit (enabled through \code{CFG.traceEnable}) configurably selects and compresses trace information into a byte stream. While the byte stream is being written to the memory system or peripheral connected to the trace interface of the core, this unit ensures that the core is properly stalled.
}
