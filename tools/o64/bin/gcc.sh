...
O64=$DIR/..
RVRW=$DIR/../../rvex-release-4.0

# Toolchain binaries.
CC=$O64/open64_8issue/bin/st200-gcc
...
CFLAGS+="-fno-strength-reduce -nostdlib --no-deadcode --icache-opt=off "
...
#ASFLAGS+="-Ya,$O64/open64_8issue/bin "
#LDFLAGS+="-Yl,$O64/open64_8issue/bin -Wl,-q,-x"
