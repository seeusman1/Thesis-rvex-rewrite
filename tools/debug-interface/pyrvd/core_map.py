...
class Context:
    ...
    def __init__(self, rvd, base_address, index):
        ...
        self._CMC1 = self._CREG_CTXT + 0x0A0
        self._CMC2 = self._CREG_CTXT + 0x0A4
        self._PTP = self._CREG_CTXT + 0x0A8
        self._ASID = self._CREG_CTXT + 0x0AC
        self._TFLO = self._CREG_CTXT + 0x0B0                                                         ## GENERATED ##
        self._TFHI = self._CREG_CTXT + 0x0B4
        self._TFID = self._CREG_CTXT + 0x0B8
        ...
        self._BUN = self._CREG_CTXT + 0x110
        self._BUNH = self._CREG_CTXT + 0x114
        self._SYL = self._CREG_CTXT + 0x118
        self._SYLH = self._CREG_CTXT + 0x11C                                                         ## GENERATED ##
        ...
        self._DRACC = self._CREG_CTXT + 0x138
        self._DRACCH = self._CREG_CTXT + 0x13C
        self._DRMISS = self._CREG_CTXT + 0x140
        self._DRMISSH = self._CREG_CTXT + 0x144                                                      ## GENERATED ##
        ...
        self._DWBUF = self._CREG_CTXT + 0x160
    ...
    FIELD_CCR_BRANCH = property(                                                                     ## GENERATED ##
    ...
    FIELD_CCR_M = property(
        lambda self: (self.CCR & 0x00000C00) >> 10,
    ...
    FIELD_SCCR_M = property(
        lambda self: (self.SCCR & 0x00000C00) >> 10,
        lambda s, val: setattr(s, 'SCCR', ((val << 10) & 0x00000C00) |
            (self.SCCR & ~0x00000C00)))
    FIELD_SCCR_K = property(
        lambda self: (self.SCCR & 0x00000300) >> 8,                                                  ## GENERATED ##
        lambda s, val: setattr(s, 'SCCR', ((val << 8) & 0x00000300) |
            (self.SCCR & ~0x00000300)))
    FIELD_SCCR_C = property(
        lambda self: (self.SCCR & 0x000000C0) >> 6,
    ...
    LR = property(lambda s: s._rvd.readInt(s._LR, 4),
        lambda s, v: s._rvd.writeInt(s._LR, 4, v))                                                   ## GENERATED ##
    ...
    FIELD_PH_PH = property(
        lambda self: (self.PH & 0xFFFFFFFF) >> 0,                                                    ## GENERATED ##
    ...
    TA = property(lambda s: s._rvd.readInt(s._TA, 4),
        lambda s, v: s._rvd.writeInt(s._TA, 4, v))                                                   ## GENERATED ##
    ...
    FIELD_BR2_BR2 = property(
        lambda self: (self.BR2 & 0xFFFFFFFF) >> 0,                                                   ## GENERATED ##
    ...
    DCR = property(lambda s: s._rvd.readInt(s._DCR, 4),
        lambda s, v: s._rvd.writeInt(s._DCR, 4, v))                                                  ## GENERATED ##
    ...
    FIELD_DCR2_TRCAP = property(
        ...
        lambda self, val:raise_(RuntimeError('Cannot write to field')))
    FIELD_DCR2_T = property(                                                                         ## GENERATED ##
    ...
    FIELD_DCR2_R = property(
        ...
        lambda s, val: setattr(s, 'DCR2', ((val << 5) & 0x00000020) |                                ## GENERATED ##
    ...
    FIELD_DCR2_E = property(                                                                         ## GENERATED ##
    ...
    WCFG = property(lambda s: s._rvd.readInt(s._WCFG, 4),
        lambda s, v: raise_(RuntimeError("WCFG is not writable")))                                   ## GENERATED ##
    ...
    FIELD_SAWC_S = property(                                                                         ## GENERATED ##
    ...
    SCRP2 = property(lambda s: s._rvd.readInt(s._SCRP2, 4),
        lambda s, v: s._rvd.writeInt(s._SCRP2, 4, v))                                                ## GENERATED ##
    ...
    FIELD_SCRP3_SCRP3 = property(
        ...
        lambda s, val: setattr(s, 'SCRP3', ((val << 0) & 0xFFFFFFFF) |
            (self.SCRP3 & ~0xFFFFFFFF)))                                                             ## GENERATED ##
    ...
    FIELD_RSC_RSC = property(
        lambda self: (self.RSC & 0xFFFFFFFF) >> 0,                                                   ## GENERATED ##
    ...
    RSC1 = property(lambda s: s._rvd.readInt(s._RSC1, 4),
        lambda s, v: s._rvd.writeInt(s._RSC1, 4, v))                                                 ## GENERATED ##
    ...
    FIELD_RSC2_RSC2 = property(
        ...
        lambda s, val: setattr(s, 'RSC2', ((val << 0) & 0xFFFFFFFF) |
            (self.RSC2 & ~0xFFFFFFFF)))                                                              ## GENERATED ##
    ...
    FIELD_RSC4_RSC4 = property(
        lambda self: (self.RSC4 & 0xFFFFFFFF) >> 0,                                                  ## GENERATED ##
    ...
    RSC6 = property(lambda s: s._rvd.readInt(s._RSC6, 4),
        lambda s, v: s._rvd.writeInt(s._RSC6, 4, v))                                                 ## GENERATED ##
    ...
    FIELD_RSC7_RSC7 = property(
        ...
        lambda s, val: setattr(s, 'RSC7', ((val << 0) & 0xFFFFFFFF) |
            (self.RSC7 & ~0xFFFFFFFF)))                                                              ## GENERATED ##
    ...
    FIELD_CSC7_CSC7 = property(
        ...
        lambda self, val:raise_(RuntimeError('Cannot write to field')))
    CMC1 = property(lambda s: s._rvd.readInt(s._CMC1, 4),
        lambda s, v: s._rvd.writeInt(s._CMC1, 4, v))
    FIELD_CMC1_BLP = property(
    ...
    PTP = property(lambda s: s._rvd.readInt(s._PTP, 4),
    ...
    FIELD_ASID_ASID = property(
        ...
        lambda s, val: setattr(s, 'ASID', ((val << 0) & 0xFFFFFFFF) |
