...
int runGdb(commandLineArgs_t *args) {
  ...
  if (isHelp(args) || (args->paramCount < 1)) {
    printf(
      ...
      "  _GDB_BRKPT   - This should return a valid debug trap syllable for the core.\n"
      ...
      "                 address can be accessed using _GDB_BRKPT_SYL and _GDB_BRKPT_ADDR\n"
      "                 respectively, should the soft breakpoint syllable depend on\n"
      "                 these values.\n"
      "  _GDB_WATCH   - This should set or remove a watchpoint, depending on\n"
      "                 _GDB_WATCH_TYPE and _GDB_WATCH_INDEX. _GDB_WATCH_TYPE will have\n"
      "                 one of the following values:\n"
      "                   0 - clear this watchpoint.\n"
      "                   1 - set read watchpoint.\n"
      "                   2 - set write watchpoint.\n"
      "                   3 - set access watchpoint.\n"
      "                 The address for the watchpoint is loaded into _GDB_WATCH_ADDR.\n"
