...
//#include <newlib.h> //st200 includes this file, but we may be linking with uclibc instead
...
# if !defined __GNUC__ || __GNUC__ < 2 || defined __open64__
...
#if defined __GNUC__ && !defined _GCC_LIMITS_H_ && !defined __open64__
