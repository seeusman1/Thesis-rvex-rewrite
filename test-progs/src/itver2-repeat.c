...
int main(void)
{
	...
	while (1) {
		...
		// Dump a progress character every 100 times to indicate that we haven't
		// crashed.
		j++;
		if (j == 100) {
			putchar('.');
